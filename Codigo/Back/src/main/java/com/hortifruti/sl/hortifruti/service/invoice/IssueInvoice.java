...
public class IssueInvoice {
    ...
    private CombinedScore fetchCombinedScore(Long combinedScoreId) {
        return combinedScoreRepository.findById(combinedScoreId)
    ...
    private IssueInvoiceRequest buildInvoiceRequest(Long combinedScoreId, RecipientRequest recipient, List<ItemRequest> items) {
    ...
    private void updateCombinedScoreStatus(CombinedScore combinedScore, InvoiceResponse notaFiscalResponse) {
