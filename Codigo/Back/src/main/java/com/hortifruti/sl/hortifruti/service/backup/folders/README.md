...
| `FolderManager.java` | `@Component` | Busca o ID de uma pasta por nome (+ pasta pai opcional) via `DriveQueryBuilder`, ou cria a pasta caso não exista; mantém um método de compatibilidade que extrai o nome a partir de um "caminho". |
