 ...
 * SecurityFilter#isPasswordChangeAllowedPath}). Diferente de {@link UserUpdateRequest}, aqui
 * {@code username} e {@code password} são obrigatórios: {@code username} identifica o usuário (não
 * há {@code @PathVariable} nesta rota) e {@code password} é exatamente o dado que a operação existe
