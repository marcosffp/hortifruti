...
public record BulkNotificationResponse(
    ...
    public static BulkNotificationResponse failure(String message, List<String> failedRecipients) {
        return new BulkNotificationResponse(false, message, 0, failedRecipients.size(), failedRecipients);
    }
    
    public static BulkNotificationResponse partial(int totalSent, int totalFailed, List<String> failedRecipients) {
