...
public class BilletCancel {
     ...
     */
    public ResponseEntity<String> cancelBillet(Long idCombinedScore) throws IOException, BilletException {
        CombinedScore combinedScore = billetInfoCombinedAndClient.findCombinedScoreById(idCombinedScore);
        ...
        try {
            ...
            throw new BilletException("Erro na requisição para baixar o boleto: " + e.getResponseBodyAsString());
    ...
    private ResponseEntity<String> handleCancelResponse(JsonNode response, CombinedScore combinedScore) {
        if (response == null) {
