 ...
 *
 * <p>Gerencia a comunicação entre a API UltraMsg e o sistema interno, recebendo mensagens através
 * de webhooks e fornecendo endpoints de teste e debug para desenvolvimento.
 */
@RestController
...
@Tag(
    ...
    description = "Endpoints para o chatbot do WhatsApp via UltraMsg API")
public class ChatbotController {
  ...
  @Operation(
      ...
      description =
          "Endpoint que recebe mensagens enviadas pelos clientes via WhatsApp através da UltraMsg API")
  @ApiResponses(
      value = {
   ...
   *
   * <p>Utilizado para validar e confirmar a configuração do webhook na plataforma UltraMsg.
   *
  ...
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Webhook verificado com sucesso")})
   ...
   *
   * <p>Permite simular o envio de mensagens sem depender da integração com o WhatsApp, facilitando
   * testes e debug.
   *
  ...
  @Operation(
      ...
      description =
          "Endpoint para testar o funcionamento do chatbot simulando uma mensagem recebida")
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<String> testChatbot(
      @Parameter(
              description = "Número do WhatsApp do cliente (ex: 31999999999)",
              required = true,
              example = "31999999999")
          @RequestParam
          String phoneNumber,
      @Parameter(
              description = "Mensagem a ser testada",
              required = true,
              example = "quero meus boletos")
          @RequestParam
          String message) {
    try {
   ...
   *
   * <p>Permite testar o chatbot com um payload JSON estruturado similar ao que seria enviado pela
   * UltraMsg, possibilitando testes mais realistas e completos.
   *
  ...
  @Operation(
      ...
      description =
          "Endpoint para testar o chatbot com um payload JSON similar ao que seria enviado pela UltraMsg")
  @ApiResponses(
      value = {
        @ApiResponse(responseCode = "200", description = "Teste executado com sucesso"),
        @ApiResponse(responseCode = "500", description = "Erro durante o teste")
