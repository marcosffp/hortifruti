    ...
    <div className="grid gap-4 sm:gap-6 w-full max-w-full overflow-x-hidden">
      ...
      <Card title="Filtros">
        <p className="text-sm text-gray-500 mb-4">
          Ajuste os campos abaixo e clique em <strong>Aplicar Filtro</strong>{" "}
          para atualizar os gráficos. O intervalo de{" "}
          <strong>Data Inicial</strong> e <strong>Data Final</strong> aplicado
          aqui também é usado pelo botão{" "}
