...
export default function ClientCard({
  ...
  return (
    <div className="grid grid-cols-12 gap-4 px-6 py-4 border-b items-center hover:bg-gray-50 transition-colors">
      ...
      <div className="col-span-2 text-gray-700">{telefone}</div>
      <div className="col-span-3 text-gray-700 truncate">{endereco}</div>
      ...
      <div className="col-span-1 text-gray-700">{ultimaCompra}</div>
      <div className="col-span-1">
