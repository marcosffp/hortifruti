                            ...
                            >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <button
                                        ...
                                        className="w-full flex items-center justify-center gap-2 px-3 py-2 bg-blue-800 text-white rounded-lg hover:bg-blue-900 transition-colors text-sm cursor-pointer"
                                    >
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        {score.hasBillet ? (
                                            ...
                                            <button
                                                ...
                                                className="flex items-center justify-center gap-1 px-2 py-2 bg-blue-800 text-white rounded-lg hover:bg-blue-900 transition-colors text-xs cursor-pointer"
                                            >
